	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-hero" clsas="js-fullheight">
			<div class="flexslider js-fullheight">
				<ul class="slides">
					<li style="background-image: url(<?php echo base_url() . 'theme/images/contactwebgen.png' ?>);">
				...
				<div class="row">
					<div class="col-md-3">
						...
						<ul class="contact-info">
							<li><i class="icon-map"></i>Jl.Pahlawan No.45, Cibeunying Kaler, Kota Bandung</li>
							<li><i class="icon-phone"></i>(023)11239201</li>
							<li><i class="icon-envelope"></i><a href="#">webgenius.gmail.com</a></li>
							<li><i class="icon-globe"></i><a href="#">webgenius.co.id</a></li>
						</ul>
					</div>
